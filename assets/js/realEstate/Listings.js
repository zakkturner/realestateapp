        ...
        <section className="sortby-area">
          <div className="results">{this.props.globalState.filteredData.length} results found</div>
            <div className="sort-options">
              ...
              <div className="view" >
                  <i className="fa fa-2x fa-th-list" aria-hidden="true" onClick={this.props.changeView.bind(null, "long")}></i>
                  <i className="fa fa-2x fa-th" aria-hidden="true" onClick={this.props.changeView.bind(null, "box")}></i>
